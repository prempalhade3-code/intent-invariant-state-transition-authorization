  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit}>
        <div
          className={cn(
            "relative bg-paper border rounded-2xl transition-all duration-200",
            focused
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 pt-4 pb-2 border-b border-border">
            ...
            <div className="flex items-center gap-1.5 text-xs text-ink-faint">
              ...
              <span>Policy sealed on submit</span>
            </div>
          </div>
          ...
          <div className="px-5 py-4">
            <textarea
              ...
              className={cn(
                ...
                "text-lg font-normal text-ink leading-relaxed",
          ...
          <div className="flex items-center justify-between px-5 py-3 border-t border-border">
            <p className="text-xs text-ink-faint">
              Budget, merchant, tools, and domains are bound before the agent runs.
              <span className="hidden sm:inline"> The model cannot expand its own authority.</span>
            </p>
